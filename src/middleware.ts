...
const PUBLIC_PATHS = new Set(["/login", "/onboarding", "/forgot-password", "/reset-password", "/expired", "/subscribe", "/subscribe/success", "/signup/success", "/legal/privacy", "/legal/terms"])
