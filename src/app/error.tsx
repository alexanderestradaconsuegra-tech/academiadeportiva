      ...
      <body>
        <div className="min-h-screen flex items-center justify-center bg-white dark:bg-slate-950 px-4">
          <div className="max-w-sm w-full text-center">
            ...
            <h1 className="text-lg font-bold text-slate-900 dark:text-white mb-1.5">Algo salió mal</h1>
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">
              Ocurrió un error inesperado. Intenta de nuevo, si sigue pasando avísale al entrenador.
            </p>
            <button
              onClick={reset}
